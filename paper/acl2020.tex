...
\author{Tova Erbén  \\
  ...
  \texttt{guserbto@student.gu.se}} \\\And
...
\maketitle
\begin{abstract}
This work aims to explore some different methods available for normalization and lemmatisation of historical texts: substitution-based methods (Norma) and character-based statistical machine translation (cSMTiser). The material used in this endeavour is the MAþiR resource from Språkbanken Text, containing texts in Old Swedish (ca 1225-1526).
\end{abstract}

\section{Introduction}

Introduction, Materials and methods, Results, Discussion, Conclusions and further work, 
